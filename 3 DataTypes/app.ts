...
// let person_name : string = "Nawaz sharif";
// console.log(person_name);

import { lookup, lookupService } from "dns/promises";
...
// let random_num : any = 9;
// console.log(random_num);
 
// let fruits_name : any = [`Apple`,`Banana`,`kiwi`,`Peach`,`Orange`];
...
// let number : BigInt = 12345678910588885566622299n
// console.log(number);

// ## Task 8:
// - Declare a variable with "let". Its value will be a symbol. Add a comment about your variable.

// let sym1 :symbol  = Symbol ("Ayesha");
// let sym2 : symbol = Symbol ("Aiza");
// console.log(sym2);
